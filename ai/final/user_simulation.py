...
if __name__ == "__main__":
    ...
    # Option 1 : Générer un dataset 100% synthétique
    # (utile pour test rapide du classificateur)
    # df = generate_synthetic_dataset(
    #     n_users=100,
    #     sessions_per_user=3,
    #     windows_per_session=48,
    #     output_path=os.path.join(SCRIPT_DIR, 'synthetic_features_dataset.csv')
    # )
    
    # Option 2 : Augmenter le dataset existant avec données synthétiques
    # (RECOMMANDÉ pour plus de données d'entraînement)
    ...
    if os.path.exists(features_path):
        ...
        print("Générez d'abord les données réelles avec process_data.py")
        sys.exit(1)
